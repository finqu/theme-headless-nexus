...
| done    | Category          | `PRODUCT_GROUP` | `ProductGroupTemplate` uses `getProductGroup` + `getProductGroupWithProducts`, reuses `ProductGrid` / `ProductBreadcrumb`, URL sort/pagination, SEO from group.  |
