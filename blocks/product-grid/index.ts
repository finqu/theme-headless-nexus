...
export { ProductGrid, productGridDefaultProps } from '@/components/product-grid';
export type { ProductGridViewProps, ProductGridColumns } from '@/components/product-grid';
