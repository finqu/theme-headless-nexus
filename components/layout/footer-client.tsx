...
/**
 * Client component version of Footer for use in Puck editor
 * Receives all data as props instead of fetching server-side
 */
export function FooterClient({
  ...
  // Helper to handle links in edit mode
