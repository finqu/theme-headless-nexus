 ...
 * Fetches via GET_PRODUCT_GROUP + GET_PRODUCT_GROUP_WITH_PRODUCTS and reuses the catalog grid.
 */
export async function ProductGroupTemplate({
  ...
  let listing: ProductGroupListing | null;
  try {
...
function CategoryPagination({
  ...
  const pages: number[] = [];
  for (const n of [1, page - 1, page, page + 1, totalPages]) {
